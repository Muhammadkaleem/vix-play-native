...
/** Placeholder until the equalizer lands (Roadmap Step 6 — Reach). */
...
fun EqualizerScreen(
    ...
    Scaffold(
        ...
        LibraryEmptyState(
            ...
            title = "Equalizer coming soon",
            body = "Shape your sound with band gains, presets, and bass boost. Arriving in a future update.",
