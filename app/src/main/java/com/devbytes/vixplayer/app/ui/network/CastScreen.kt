...
/** Placeholder until Chromecast lands (Roadmap Step 6 — Reach). */
...
fun CastScreen(
    ...
    Scaffold(
        ...
        LibraryEmptyState(
            ...
            title = "Casting coming soon",
            body = "Send video to Chromecast and other cast targets on your network. Arriving in a future update.",
